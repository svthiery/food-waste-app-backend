...
# Pickup.create(available: true, price: rand(5..25), restaurant_id: Restaurant.all.sample.id, user_id: nil, item: "Kebab", image: "https://cititour.com/NYC_Restaurants/photos/16054_Kebab%20Empire%2C%20Hell%27s%20Kitchen%2C%20NYC.jpg")
# Pickup.create(available: true, price: rand(5..25), restaurant_id: Restaurant.all.sample.id, user_id: nil, item: "California Maki", image: 
# Pickup.create(available: true, price: rand(5..25), restaurant_id: Restaurant.all.sample.id, user_id: nil, item: "Stinky Tofu", image: 
# Pickup.create(available: true, price: rand(5..25), restaurant_id: Restaurant.all.sample.id, user_id: nil, item: "Risotto with Seafood", image:
# Pickup.create(available: true, price: rand(5..25), restaurant_id: Restaurant.all.sample.id, user_id: nil, item: "Vegetable Soup", image:
...
# Pickup.create(available: true, price: rand(5..25), restaurant_id: Restaurant.all.sample.id, user_id: nil, item: "Scotch Eggs", image: 
...
# Pickup.create(available: true, price: rand(5..25), restaurant_id: Restaurant.all.sample.id, user_id: nil, item: "Scotch Eggs", image:
# Pickup.create(available: true, price: rand(5..25), restaurant_id: Restaurant.all.sample.id, user_id: nil, item: "Risotto with Seafood", image: 
# Pickup.create(available: true, price: rand(5..25), restaurant_id: Restaurant.all.sample.id, user_id: nil, item: "Pappardelle alla Bolognese", image:
# Pickup.create(available: true, price: rand(5..25), restaurant_id: Restaurant.all.sample.id, user_id: nil, item: "French Toast", image: 
...
# Pickup.create(available: true, price: rand(5..25), restaurant_id: Restaurant.all.sample.id, user_id: nil, item: "Mushroom Risotto", image:
...
# Pickup.create(available: true, price: rand(5..25), restaurant_id: Restaurant.all.sample.id, user_id: nil, item: "Massaman Curry", image:  "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTApbMZfxRciwQB8vnB-siaxGvKHAfL1bYHRw&usqp=CAU")
# Pickup.create(available: true, price: rand(5..25), restaurant_id: Restaurant.all.sample.id, user_id: nil, item: "Poutine", image: 
# Pickup.create(available: true, price: rand(5..25), restaurant_id: Restaurant.all.sample.id, user_id: nil, item: "California Maki", image: 
...
# Pickup.create(available: true, price: rand(5..25), restaurant_id: Restaurant.all.sample.id, user_id: nil, item: "Bruschette with Tomato", image:
# Pickup.create(available: true, price: rand(5..25), restaurant_id: Restaurant.all.sample.id, user_id: nil, item: "Massaman Curry", image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTApbMZfxRciwQB8vnB-siaxGvKHAfL1bYHRw&usqp=CAU")
# Pickup.create(available: true, price: rand(5..25), restaurant_id: Restaurant.all.sample.id, user_id: nil, item: "Teriyaki Chicken Donburi", image: 
# Pickup.create(available: true, price: rand(5..25), restaurant_id: Restaurant.all.sample.id, user_id: nil, item: "Linguine with Clams", image: 
...
# Pickup.create(available: true, price: rand(5..25), restaurant_id: Restaurant.all.sample.id, user_id: nil, item: "Linguine with Clams", image: 
# Pickup.create(available: true, price: rand(5..25), restaurant_id: Restaurant.all.sample.id, user_id: nil, item: "Philadelphia Maki", image: 
...
# Pickup.create(available: true, price: rand(5..25), restaurant_id: Restaurant.all.sample.id, user_id: nil, item: "Seafood Paella", image:
...
# Pickup.create(available: true, price: rand(5..25), restaurant_id: Restaurant.all.sample.id, user_id: nil, item: "Meatballs with Sauce", image: 
# Pickup.create(available: true, price: rand(5..25), restaurant_id: Restaurant.all.sample.id, user_id: nil, item: "Fettuccine Alfredo", image: 
# Pickup.create(available: true, price: rand(5..25), restaurant_id: Restaurant.all.sample.id, user_id: nil, item: "Meatballs with Sauce", image: 
...
# Pickup.create(available: true, price: rand(5..25), restaurant_id: Restaurant.all.sample.id, user_id: nil, item: "Poke", image: 
# Pickup.create(available: true, price: rand(5..25), restaurant_id: Restaurant.all.sample.id, user_id: nil, item: "Philadelphia Maki", image: 
...
# Pickup.create(available: true, price: rand(5..25), restaurant_id: Restaurant.all.sample.id, user_id: nil, item: "Ricotta Stuffed Ravioli", image: 
# Pickup.create(available: true, price: rand(5..25), restaurant_id: Restaurant.all.sample.id, user_id: nil, item: "Scotch Eggs", image: 
# Pickup.create(available: true, price: rand(5..25), restaurant_id: Restaurant.all.sample.id, user_id: nil, item: "Lasagne", image: 
# Pickup.create(available: true, price: rand(5..25), restaurant_id: Restaurant.all.sample.id, user_id: nil, item: "Pork Belly Buns", image: 
# Pickup.create(available: true, price: rand(5..25), restaurant_id: Restaurant.all.sample.id, user_id: nil, item: "Pork Belly Buns", image: 
# Pickup.create(available: true, price: rand(5..25), restaurant_id: Restaurant.all.sample.id, user_id: nil, item: "French Fries with Sausages", image:
# Pickup.create(available: true, price: rand(5..25), restaurant_id: Restaurant.all.sample.id, user_id: nil, item: "Lasagne", image: 
# Pickup.create(available: true, price: rand(5..25), restaurant_id: Restaurant.all.sample.id, user_id: nil, item: "Pasta with Tomato and Basil", image: 
# Pickup.create(available: true, price: rand(5..25), restaurant_id: Restaurant.all.sample.id, user_id: nil, item: "Poke", image: 
# Pickup.create(available: true, price: rand(5..25), restaurant_id: Restaurant.all.sample.id, user_id: nil, item: "Hummus", image: 
# Pickup.create(available: true, price: rand(5..25), restaurant_id: Restaurant.all.sample.id, user_id: nil, item: "Teriyaki Chicken Donburi", image: 
...
# Pickup.create(available: true, price: rand(5..25), restaurant_id: Restaurant.all.sample.id, user_id: nil, item: "Risotto with Seafood", image: 
# Pickup.create(available: true, price: rand(5..25), restaurant_id: Restaurant.all.sample.id, user_id: nil, item: "Pasta and Beans", image: 
# Pickup.create(available: true, price: rand(5..25), restaurant_id: Restaurant.all.sample.id, user_id: nil, item: "Pierogi", image: 
# Pickup.create(available: true, price: rand(5..25), restaurant_id: Restaurant.all.sample.id, user_id: nil, item: "Pierogi", image: 
# Pickup.create(available: true, price: rand(5..25), restaurant_id: Restaurant.all.sample.id, user_id: nil, item: "Ricotta Stuffed Ravioli", image: 
# Pickup.create(available: true, price: rand(5..25), restaurant_id: Restaurant.all.sample.id, user_id: nil, item: "Chicken Wings", image: 
# Pickup.create(available: true, price: rand(5..25), restaurant_id: Restaurant.all.sample.id, user_id: nil, item: "Pork Belly Buns", image: 
# Pickup.create(available: true, price: rand(5..25), restaurant_id: Restaurant.all.sample.id, user_id: nil, item: "Stinky Tofu", image: 
...
# Pickup.create(available: true, price: rand(5..25), restaurant_id: Restaurant.all.sample.id, user_id: nil, item: "Poutine", image: 
# Pickup.create(available: true, price: rand(5..25), restaurant_id: Restaurant.all.sample.id, user_id: nil, item: "French Toast", image: 
# Pickup.create(available: true, price: rand(5..25), restaurant_id: Restaurant.all.sample.id, user_id: nil, item: "Bunny Chow", image:
# Pickup.create(available: true, price: rand(5..25), restaurant_id: Restaurant.all.sample.id, user_id: nil, item: "Poke", image: 
# Pickup.create(available: true, price: rand(5..25), restaurant_id: Restaurant.all.sample.id, user_id: nil, item: "Salmon Nigiri", image: 
# Pickup.create(available: true, price: rand(5..25), restaurant_id: Restaurant.all.sample.id, user_id: nil, item: "French Fries with Sausages", image: 
